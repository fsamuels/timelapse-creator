...
capturing all ten cams via a systemd timer (15 min for most, 60 min for unca-tower). The
...
running the systemd capture timer against `capture/config.pi.yaml` (all ten cams) and
