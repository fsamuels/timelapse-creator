...
def test_latest_frame_returns_lexically_last_file(tmp_path):
    ...
    (month_dir / "2026-07-16T20-00-00-000000Z.jpg").write_bytes(b"first")
    latest = month_dir / "2026-07-16T20-15-00-000000Z.jpg"
...
def test_is_stale_true_for_identical_bytes(tmp_path):
    month_dir = tmp_path / "2026" / "07"
    month_dir.mkdir(parents=True)
    (month_dir / "2026-07-16T20-00-00-000000Z.jpg").write_bytes(b"same bytes")
...
def test_is_stale_false_for_different_bytes(tmp_path):
    month_dir = tmp_path / "2026" / "07"
    month_dir.mkdir(parents=True)
    (month_dir / "2026-07-16T20-00-00-000000Z.jpg").write_bytes(b"old frame")
